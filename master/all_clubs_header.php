				...
				<div class="row">
					<div class="col-xs-8">
						<div id="fh5co-logo">
							...
							<a href="index.php">
							<span id="org_name">ALL CLUBS EVENTS PAGE</span>
						</a>
						</div>
					</div>
					
					<div class="col-xs-4 col-md-4">
					<nav class="navbar navbar-expand-sm navbar-light bg-light navbar-right">
						  <ul class="navbar-nav">
							<li class="nav-item">
							  <a class="navbar-link" href="../">All Clubs Home Page</a>
							</li>
