...
if (isset($_POST["sub"])) {
    ...
    if ($tagline2 <> "" && $tagline1 <> "" && $about <>"" && $orgName <>""&& $email <>"") {
        ...
        $sql = "INSERT INTO mp_main (`org_id`, `tagline1`, `tagline2`, `facebookLink`, `instagramLink`, `email`, `linkedinLink`, `org_name`, `about`) VALUES 
        (:oid,:tg1, :tg2, :fb, :insta, :email, :lkdin, :orgname, :about)";
